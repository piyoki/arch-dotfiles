...
function settings.setup()
  ...
  utils.opt("b", "tabstop", 4) -- insert the number of spaces for a tab
  utils.opt("b", "shiftwidth", 4) -- change the number of space characters inserted for indentation
  utils.opt("b", "softtabstop", 4) -- set the number of columns for a TAB
